...
import '../../blocs/lawyer_block/lawyer_block.dart';
import '../../blocs/lawyer_block/lawyer_event.dart';
import '../../blocs/lawyer_block/lawyer_state.dart';
...
class _LawyersScreenState extends State<LawyersScreen> {
  ...
  void _onSearch(String lawyerId) {
    if (lawyerId.trim().isNotEmpty) {
      ...
      if (id != null) {
        bloc.add(GetLawyerById(lawyerId: id));
      } else {
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: IconButton(
                onPressed: () {
                  bloc.add(DeleteLawyerById(lawyerId: lawyer.id));
                },
