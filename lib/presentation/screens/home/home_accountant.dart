            ...
            Expanded(
              child: CustomCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const EmployeeSalariesPage()),
                  );
                },
              ),
            ),
            ...
            Expanded(
              child: CustomCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SalaryVerificationPage()),
                  );
                },
              ),
            ),
            ...
            Expanded(
              child: CustomCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SalarySchedulePage()),
                  );
                },
              ),
            ),
      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            decoration: const BoxDecoration(color: Color(0xFF62D284)),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: InkWell(
        onTap: onTap,
        child: Card(//EBEBEB
          color: Color(0xFFEBEBEB), // ← هنا لون الكارد الرمادي الفاتح
          elevation: 6,
