      ...
      body: BlocConsumer<UserProfileBloc, UserProfileState>(
        ...
        builder: (context, state) {
          if (state is UserProfileLoadedSuccessfully) {
            ...
            emailController = TextEditingController(text: userProfileModel!.email);
            phoneController = TextEditingController(text: userProfileModel!.phone);
            addressController = TextEditingController(text: userProfileModel!.address);
            ageController = TextEditingController(text: userProfileModel!.age.toString());
            scientificLevelController = TextEditingController(text: userProfileModel!.scientificLevel);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow(Icons.location_on, "Address", addressController, isEditing),
                _buildInfoRow(Icons.cake, "Age", ageController, isEditing),
                _buildInfoRow(Icons.school, "Scientific Level", scientificLevelController, isEditing),
              ],
            ),
          ),
        ),
