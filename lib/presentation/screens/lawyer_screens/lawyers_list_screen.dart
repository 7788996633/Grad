...
import 'lawyer_profile_screens/lawyer_details_screen.dart';
...
class _LawyersScreenState extends State<LawyersListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Lawyers Directory',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
        centerTitle: true,
        elevation: 8,
